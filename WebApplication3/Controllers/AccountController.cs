...
namespace WebApplication3.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AccountSettings(bool? savedSuccesfully)
        {
            ...
            AccountSettingsViewModel model = new AccountSettingsViewModel { Email = user.Email };
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser() { UserName = model.UserName, Email = model.Email }; //this is the line where I need to add additional fields.
